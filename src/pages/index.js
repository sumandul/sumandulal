    ...
    <div>
      ...
      <div className=" bg-[#1f2336]    min-h-screen">
          ...
          <div className=" flex justify-between">
            ...
            {/* <div className=" text-white">
              <ul className=" capitalize font-medium  text-base  flex gap-4">
                <li className="  hover:text-red cursor-pointer duration-200">
                  About me
                </li>
        ...
        <div className="mx-auto container">
          <div className=" flex flex-col sm:flex-row   sm:gap-36  mt-12  sm:mt-40">
            ...
            <div className="  ml-16 order-1 z-20">
              <div
                ...
                className="  border-[6px] rounded-full overflow-hidden border-red-500 h-[15rem] w-[15rem] sm:h-[30rem] sm:w-[30rem] "
              >
                {" "}
                <div className="">
          ...
          <div className=" mt-10">
            <h1
              className=" font-bold  text-center underline    underline-offset-4    text-red-500   text-2xl
           "
            >
              About me
            </h1>
            <div className=" grid gap-10  mt-6 sm:grid-cols-3">
